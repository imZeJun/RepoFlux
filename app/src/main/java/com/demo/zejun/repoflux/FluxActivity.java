...
import com.demo.zejun.repoflux.stores.TodoStore;
...
public class FluxActivity extends AppCompatActivity {
    ...
    private ActionCreator actionsCreator;
    ...
    private void initDenpendencis() {
        dispatcher = Dispatcher.get(new Bus());
        actionsCreator = ActionCreator.get(dispatcher);
